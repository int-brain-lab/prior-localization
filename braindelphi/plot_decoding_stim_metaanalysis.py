...
#%% Block
file_all_results = 'decoding_processing/02-11-2022_stim_metaanalysis_logistic.csv'
FIG_SUF = '_metaanalysis_logistic'
...
save_comb_regs_data.to_csv(file_all_results.split('.')[0]+'_regs_nsig%s_fsig%.3f_wi2ovar%.3f%s.csv'%(n_sig,f_sig,wi2wo_var,FIG_SUF))# reg_1sigsession = lambda reg: np.any(res_table.loc[res_table['region']==reg,
