...
from bbglm_sessfit_poststim_pseudo import fit_session
...
def fit_and_save(session_id, kernlen, nbases, nickname, sessdate, filename, probe,
                 ...
                 abswheel=False, prior_estimate='charles', num_pseudosess=100.):
    outtuple = fit_session(session_id, kernlen, nbases, t_before, t_after, prior_estimate, max_len,
                           probe, contnorm, binwidth, abswheel, num_pseudosess=num_pseudosess,)
...
if __name__ == "__main__":
    ...
    for eid in sessdict:
        ...
        for probe in sessdict[eid]['probe']:
            filename = savepath +\
                f'{nickname}/{sessdate}_session_{currdate}_{probe}_poststim_pseudosess_fit.p'
