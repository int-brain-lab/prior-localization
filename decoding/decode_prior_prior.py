...
MODEL = expSmoothing_prevAction  # None or expSmoothing_prevAction or dut.modeldispatcher
DATE = str(date.today())
MODELFIT_PATH = '/home/bensonb/IntBrainLab/prior-localization/decoding/results/behavior/'
