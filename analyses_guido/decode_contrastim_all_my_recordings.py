...
results.to_csv(join(DATA_PATH, 'decode_contrastim_all_my_recordings'))
...
plot_h = sns.scatterplot(x='ML', y='AP', data=results, hue='f1', palette='YlOrRd',
                         size='f1', sizes=(50, 100), ax=ax1)
...
plot_settings()
plt.savefig(join(FIG_PATH, 'decode_contrastim_all_my_recordings'))
